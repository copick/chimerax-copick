...
"""
from Qt.QtWidgets import QLineEdit, QLabel
...
class DuplicateDialog(BaseEntityDialog):
    ...
    def __init__(self, original_name: str, suggested_name: str, parent=None, preset_user_id: str = None, default_user_id: str = None, object_name: str = None, object_color: tuple = None):
    ...
    def _setup_specific_ui(self):
        ...
        if self._object_name:
            ...
            self._object_display.setStyleSheet(f"""
                QLabel {{
